    ...
    return (
        <div className='bg-rose-50'>
            ...
            <div className='container mx-auto mt-8'>
                ...
                {/* Grid Starts */}
                <div class="grid gap-16 grid-cols-4 grid-rows-3">
                    <div className='drop-shadow-lg rounded-lg bg-white px-5 py-12'>
                        ...
                        <p className='text-xl mb-12'><span className='font-bold'>Speciality:</span> </p>
                        ...
                        <button
                            className="text-rose-500 hover:text-rose-500 border border-rose-500 hover:bg-rose-100 focus:ring-4 focus:ring-rose-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2"
                            >
                            {/* <span className="absolute left-0 inset-y-0 flex items-center pl-3">
                                <FontAwesomeIcon className="h-5 w-5 text-rose-400 group-hover:text-rose-600" icon={faTwitter} />
                            </span> */}
